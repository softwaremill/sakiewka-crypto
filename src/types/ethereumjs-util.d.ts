...
export function setLengthLeft(msg: Buffer | Uint8Array | any[], length: number, right?: boolean): Buffer

export function setLengthRight(msg: Buffer | Uint8Array | any[], length: number): Buffer
