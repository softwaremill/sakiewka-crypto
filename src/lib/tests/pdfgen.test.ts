...
describe('PDF Backup Sheet generator', () => {
    ...
    it('should generate base64 representation of pdf', async () => {
        ...
        expect(output).to.startWith('JVBERi0xLjMKJf////8KMTAgMCBvYmoKPDwKL1R5cGUgL1hPYmplY3QKL1N1YnR5cGUgL0ltYWdlCi9IZWlnaHQgMTI4Ci9XaWR0aCAxMjgKL')
        expect(output).to.endWith('cmVmCjEzMDE0CiUlRU9GCg==')
    })
})
